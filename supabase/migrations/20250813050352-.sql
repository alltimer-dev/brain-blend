-- Conversations & messages schema with RLS and triggers
-- Enable pgcrypto for gen_random_uuid if not enabled by default (usually enabled)
-- create extension if not exists pgcrypto; -- Supabase typically manages extensions
